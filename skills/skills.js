const skills = [
	...
	{
		name: "Chakra UI",
		icon_url: "../images/chakraUi.jpg",
		category: ["all", "frontend"]
	},
	{
		name: "Material UI",
		icon_url: "../images/materialUi.jpg",
		category: ["all", "frontend"]
	},
	{
		name: "node",
		icon_url: "../images/node.jpg",
		category: ["all", "backend"]
	}
];
...
function displaySkills(skills) {
	...
	skills.forEach((skill) => {
		...
		itemContainer.setAttribute("class", "col-lg-3 col-md-4 col-sm-6 mb-4");
		itemContainer.innerHTML = `
      <div class="card h-100 text-center skill-card">
        <div class="card-body">
          <div class="mb-3">
            <img src="${skill.icon_url}" width="64px" height="64px" alt="${skill.name} icon" loading="lazy" class="img-fluid"/>
          </div>
